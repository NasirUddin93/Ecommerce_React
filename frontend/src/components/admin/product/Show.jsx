...
const Show = () => {
    ...
    const deleteProduct = async (id) =>{
            if(confirm("Are you sure you want to delete")){
                ...
                const res =  fetch(`${apiUrl}/products/${id}`,{
                method: 'DELETE',
                headers: {
                    'Content-type':'application/json',
                    'Accept':'application/json',
            ...
            .then(result => {
                // console.log(result);
                if(result.status == 200){
                    const newCategories = products.filter(product => product.id != id)
                                            ...
                                            <tr>
                                                <td>{product.id}</td>
                                                    <td>
                                                        ...
                                                        {product.image_url? (<img src={product.image_url} alt="" width={50} />): <img src="https://placehold.co/50x50/png" alt="No Image" srcset="" /> }
